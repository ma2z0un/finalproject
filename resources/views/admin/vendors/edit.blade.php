                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">نعديل متجر
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <form class="form" action="{{ route('admin.vendors.update',$vendor->id) }}"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img src="{{ $vendor->logo }}" alt="صورة المتجر"
                                                        class="rounded-circle height-150">
                                                </div>

                                            </div>
                                            <div class="form-group">
                                                <label> لوغو التاجر </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1" name="active"
                                                                id="active" class="switchery" data-color="success"
                                                                @if ($vendor->active==1)
                                                                checked
                                                                @endif
                                                                 />
                                                            <label for="active" class="card-title ml-1">الحالة
                                                            </label>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"  id="pac-input"
                                                                class="form-control" value="{{ $vendor->address }}" placeholder=" " 
...
<script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&callback=initAutocomplete&libraries=places&v=weekly&language=ar&region=QA"
      defer
    ></script>
{{-- <script
