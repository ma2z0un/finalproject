                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="translation_lang">اختصار اللغة - {{ __('messages.'.$lang->abbr)  }} </label>
                                                            <input type="text"  id="translation_lang"
                                                                class="form-control" placeholder=" " 
                                                                name="category[{{ $index }}][translation_lang]" value="{{ $lang->abbr }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1" name="category[{{ $index }}][active]"
                                                                ...
                                                                checked />
                                                            <label for="switcheryColor4" class="card-title ml-1">الحالة - {{ __('messages.'.$lang->abbr)  }}
                                                            </label>
