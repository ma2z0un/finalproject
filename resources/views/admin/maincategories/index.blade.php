                                                ...
                                                @isset($categories)
                                                    @foreach ($categories as $category)
                                                        <tr>
                                                            ...
                                                            <th> {{ $category->name }}</th>
                                                            <th> {{ $category->translation_lang }}</th>
                                                            <th><img src="{{ $category->photo }} " alt="" style="height: 100px;width:100px;"></th>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{ route('admin.maincategories.status',$category->id) }}"
                                                                        class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1"> {{ $category->active==0 ? 'تفعيل' : 'الغاء تفعيل' }}</a>
